...
- **21-C 완료**: 관계 상태(`crewStore.relationships`) + 같은 방 근무·식사 기반 친밀도 변화 + 공유 작업 관계 보정(불화 x0.90 / 친밀 x1.04)
- **21-D 다음**: UI(크루 카드에 특성/무드 칩) + 보고서 연동(무드 급락·불화 발생 → crisis/work 보고서) + 안정화·문서
