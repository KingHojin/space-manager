...
export const CREW_EQUIPMENT = {
  "insulated-torque-rig": { id: "insulated-torque-rig", label: "절연 토크 리그", slot: "primary", contexts: ["engineering"], effect: { durationMinutes: -30, failureTier: -1 }, description: "기관실 대응 30분 단축, 실패 후유증 한 단계 완화." },
  ...
  "trauma-harness": { id: "trauma-harness", label: "외상 하네스", slot: "primary", contexts: ["medicine", "quarantine"], effect: { durationMinutes: -30, fatigueDelta: -4 }, description: "의무·격리 대응 30분 단축, 담당 피로 4 감소." },
  ...
  "rest-brace": { id: "rest-brace", label: "휴식 보조대", slot: "utility", contexts: ["piloting", "crew"], effect: { fatigueDelta: -5 }, description: "당직·지휘 대응의 피로 후유증 5 감소." },
};
