...
export default function Market() {
  ...
  const docked = currentZoneId === "anchor-station" || currentZoneId === "eos-harbor" || currentZoneId === "umbra-relay";
    ...
    <section>
      ...
      <div className="mt-5 rounded border border-slate-700/70 bg-slate-950/60 p-5">
        ...
        <p className="mt-2 text-sm text-slate-400">
          {docked ? "크레딧을 사용해 출항 전 핵심 자원을 회복할 수 있습니다." : "앵커 정거장, 에오스 항구, 엄브라 중계소 같은 정거장 구역으로 이동하면 시장 기능이 활성화됩니다."}
        </p>
